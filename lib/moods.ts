...
const T: Record<Mood, MoodTokens> = {
  ...
  joyful:   { cardFrom: '#d6f5ea', cardTo: '#8de2c9', bodyTop: '#b8f0dd', bodyMid: '#54c6a6', bodyBottom: '#218e72', cheek: '#1f7a63', cheekOpacity: 0.35, ink: '#1b1d1f', label: 'Alegre',     emoji: '🤩' },
  ...
  sleepy:   { cardFrom: '#ece4ff', cardTo: '#b9a3e8', bodyTop: '#e0d2ff', bodyMid: '#a48be0', bodyBottom: '#5b449a',                                       ink: '#1b1d1f', label: 'Dormido',    emoji: '😴' },
  neutral:  { cardFrom: '#f0eee9', cardTo: '#d6cfc1', bodyTop: '#f2eadb', bodyMid: '#cdbe9d', bodyBottom: '#7d6d4d',                                       ink: '#1b1d1f', label: 'Neutral',    emoji: '😐' },
  stressed: { cardFrom: '#ffe2cc', cardTo: '#ff8f5a', bodyTop: '#ffd2b0', bodyMid: '#ff8f5a', bodyBottom: '#bf501c',                                       ink: '#1b1d1f', label: 'Estresado',  emoji: '😣' },
};
