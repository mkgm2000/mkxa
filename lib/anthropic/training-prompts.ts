...
4. REGISTROS REALES (campo "REGISTROS REALES ÚLTIMAS 2 SEMANAS" en el mensaje del usuario) son la señal principal para decidir si se ajusta. Procesa CADA fila:
   - RPE registrado vs RPE objetivo de la fase: si supera por ≥ 1 punto de forma sostenida → reduce volumen o carga (S.G.A./supercompensación).
   - notes/week_note con palabras "molestia", "dolor", "agujetas", "cansado", "sobrecargado", "fatigado", "no pude", "lesion": baja intensidad y cita Tema 5/6.
